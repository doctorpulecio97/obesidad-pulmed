...
Genera un plan de salud COMPLETO, MUY DETALLADO y ESPECIFICO en espanol claro y neutral.
...
3. Cada comida DEBE especificar GRAMOS EXACTOS o porciones medidas. Ejemplos correctos:
   ...
   - "150 g de salmon al horno + 150 g de brocoli al vapor + 1/2 taza de quinoa cocida"
4. PROHIBIDO usar terminos vagos: NO "algo magro", NO "una proteina", NO "porcion moderada", NO "lo que prefieras". SIEMPRE alimento concreto con cantidad.
5. Lenguaje claro y simple, sin tecnicismos. Las opciones alternativas tambien con cantidades exactas.
...
2. Cada dia de ejercicio DEBE incluir: tipo de ejercicio, duracion total, ejercicios especificos con NUMERO DE REPETICIONES, NUMERO DE SERIES y TIEMPO DE DESCANSO entre series.
3. Ejemplo correcto: "Caminata rapida 30 minutos + circuito de fuerza: 3 series de 15 sentadillas, 10 flexiones de pecho (apoyadas en rodillas si es necesario), 20 abdominales y 30 segundos de plancha. Descansa 60 segundos entre series."
4. Lenguaje claro, sin jerga de gimnasio. Explicar terminos tecnicos si los usas.
